...
<head>
  ...
  <title>Get A Dream Home API</title>
...
<body>
  <div class="dash">
    ...
    <!-- Footer -->
    <div class="ftr">
      <p>&copy; ${new Date().getFullYear()} Get A Dream Home &nbsp;|&nbsp;
        <a href="/health">Health</a> &nbsp;|&nbsp;
        <a href="/status">Status</a> &nbsp;|&nbsp;
        <a href="https://Get A Dream Home.vercel.app" target="_blank">Website</a> &nbsp;|&nbsp;
