...
const CuratedListingsSection: React.FC = () => {
  ...
  return (
    <section className="bg-[#F5F5F5] pt-8 pb-12 border-t border-[#E5E7EB]">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8">

        {/* Section Header with Explore link */}
        <div className="flex items-center justify-between mb-10">
          <div>
            <p className="font-red-hat text-xs uppercase tracking-[2px] text-[#4B5563] mb-2 font-bold">Featured Listings</p>
            <h2 className="font-fraunces font-bold text-3xl sm:text-4xl lg:text-5xl text-black">Our Premium Selection</h2>
          </div>
          <Link
            to="/properties"
            className="hidden sm:inline-flex items-center gap-2 font-red-hat text-sm font-bold text-black border-b-2 border-black hover:text-[#1F3A5F] hover:border-[#1F3A5F] transition-colors uppercase tracking-widest"
          >
            Explore All
        ...
        <Link
          to="/properties"
          className="sm:hidden flex items-center gap-2 font-red-hat text-sm font-bold text-[#38BDF8] mb-8 uppercase tracking-widest"
        >
