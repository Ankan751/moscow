...
const WhatsAppButton: React.FC = () => {
  const whatsappUrl = "https://wa.me/917819081887";
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-[98px] sm:bottom-[22px] right-6 z-[9999] flex items-center justify-center w-16 h-16 sm:w-18 sm:h-18 drop-shadow-2xl active:drop-shadow-lg transition-shadow"
