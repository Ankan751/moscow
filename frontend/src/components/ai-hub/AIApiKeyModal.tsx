      ...
      <div className="relative w-full max-w-lg bg-[#1a0f0a] border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center gap-3 px-6 pb-6">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-[#1C1B1A] hover:bg-[#38BDF8] disabled:opacity-40 disabled:cursor-not-allowed text-white font-manrope font-semibold text-sm py-3 rounded-xl transition-all uppercase tracking-widest shadow-lg"
          >
  ...
  <div>
    <div className="flex items-center justify-between mb-1.5">
      ...
      <a href={linkHref} target="_blank" rel="noopener noreferrer"
        className="flex items-center gap-1 font-manrope text-[11px] text-[#38BDF8] hover:text-[#e88a6f] transition-colors">
        {linkText} <ExternalLink className="w-3 h-3" />
      </a>
    </div>
    <div className="relative bg-white/[0.07] border border-white/10 rounded-xl px-4 py-3 flex items-center gap-3 focus-within:border-[#38BDF8]/50 transition-all">
      <Key className="w-4 h-4 text-[#38BDF8]/60 shrink-0" />
      <input
