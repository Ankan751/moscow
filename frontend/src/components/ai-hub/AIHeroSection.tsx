  ...
  return (
    <section className="relative bg-[#FAF8F4] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden>
        <div className="absolute top-0 inset-x-0 h-[800px] bg-gradient-to-b from-[#38BDF8]/10 to-transparent" />
        <div className="absolute top-20 left-10 w-[500px] h-[500px] bg-[#38BDF8]/10 rounded-full blur-[100px]" />
      ...
      <div className="relative pt-32 pb-24 max-w-[1200px] mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-white/60 backdrop-blur-sm border border-[#38BDF8]/20 rounded-full px-4 py-2 mb-6 shadow-sm">
            <Sparkles className="w-4 h-4 text-[#38BDF8]" />
            <span className="font-space-mono text-xs text-[#38BDF8] uppercase tracking-wider font-semibold">
              AI-Powered Search
            </span>
          </div>
          ...
          <h1 className="font-fraunces text-5xl md:text-6xl lg:text-7xl leading-tight text-[#221410] mb-6">
            ...
            <span className="text-[#38BDF8]">AI Intelligence</span>
          </h1>
          ...
          >
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <div className="relative bg-white border border-[#E6E0DA] rounded-xl p-4 flex items-center gap-3 focus-within:ring-2 focus-within:ring-[#38BDF8]/30 focus-within:border-[#38BDF8] transition-all shadow-sm">
                ...
                {POPULAR_CITIES.map((c) => (
                  <button
                    ...
                    className={`font-manrope text-xs px-4 py-1.5 rounded-full border transition-all ${city === c
                      ? 'bg-[#38BDF8] border-[#38BDF8] text-white font-medium shadow-sm'
                      : 'bg-white border-[#E6E0DA] text-[#6B7280] hover:border-[#38BDF8]/50 hover:text-[#38BDF8]'
                      }`}
                  >
                    {c}
                  </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
              ...
              <div>
                    ...
                    {(['Lakh', 'Cr'] as BudgetUnit[]).map((unit) => (
                      <button
                        ...
                        className={`font-space-mono text-[10px] uppercase font-bold px-2.5 py-1 transition-all rounded-sm ${budgetUnit === unit
                          ? 'bg-white shadow-sm text-[#38BDF8]'
                ...
                <div className="relative bg-white border border-[#E6E0DA] rounded-xl p-4 flex items-center gap-3 focus-within:ring-2 focus-within:ring-[#38BDF8]/30 focus-within:border-[#38BDF8] transition-all shadow-sm">
                  <IndianRupee className="w-5 h-5 text-[#38BDF8] shrink-0" />
                  <input
                    type="number"
                    value={maxBudget}
              ...
              <div>
                ...
                <div className="relative bg-white border border-[#E6E0DA] rounded-xl p-4 flex items-center gap-3 focus-within:ring-2 focus-within:ring-[#38BDF8]/30 focus-within:border-[#38BDF8] transition-all shadow-sm">
                  <Home className="w-5 h-5 text-[#38BDF8] shrink-0" />
                  <select
                    value={propertyType}
                ...
                {(['Any', '1BHK', '2BHK', '3BHK', '4BHK+'] as const).map((option) => (
                  <button
                    ...
                    className={`font-manrope text-sm font-medium px-5 py-2.5 rounded-xl border transition-all ${
                      bhk === option
                        ? 'bg-[#38BDF8] border-[#38BDF8] text-white shadow-sm'
                        : 'bg-white border-[#E6E0DA] text-[#6B7280] hover:border-[#38BDF8]/50 hover:text-[#38BDF8]'
                    }`}
                  >
            ...
            <div className="relative group mt-2">
              <button
                ...
                className="w-full bg-[#1C1B1A] hover:bg-[#38BDF8] disabled:opacity-50 disabled:cursor-not-allowed text-white font-manrope font-semibold text-lg py-4 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-xl mt-2 uppercase tracking-widest"
              >
                {loading ? (
                  <>
                    ...
                    return (
                      <div key={s.label} className={`flex items-start gap-3 transition-opacity duration-500 ${isPending ? 'opacity-35' : 'opacity-100'}`}>
                        <div className="mt-0.5 shrink-0 w-5 h-5 flex items-center justify-center">
                          ...
                          : isActive ? <Loader2 className="w-5 h-5 text-[#38BDF8] animate-spin" />
                          :            <div className="w-4 h-4 rounded-full border-2 border-[#38BDF8]/30" />}
                        </div>
                        <div>
