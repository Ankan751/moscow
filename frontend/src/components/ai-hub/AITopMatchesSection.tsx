        ...
        <div className="flex items-center justify-between mb-10">
          <div className="flex items-baseline gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-space-mono font-bold text-2xl text-[#38BDF8]">
                97%
              </span>
          ...
          <button className="font-space-mono text-sm text-[#221410] border-b border-[#221410] hover:text-[#38BDF8] hover:border-[#38BDF8] transition-colors pb-1">
            View All → See more
          </button>
        </div>
          ...
          {properties.map((property) => (
            ...
            >
              ...
              <div className="relative aspect-[382/286.5] overflow-hidden">
                ...
                {/* Badge */}
                <div className="absolute top-4 left-4 bg-[#38BDF8] text-white font-space-mono text-xs px-3 py-1.5 rounded-full shadow-lg">
                  {property.badge}
                </div>
              ...
              <div className="p-6">
                ...
                <p className="font-space-mono font-bold text-lg text-[#38BDF8] mb-4">
                  {property.price}
                </p>
