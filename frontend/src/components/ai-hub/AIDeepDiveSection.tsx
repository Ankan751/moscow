  ...
  return (
    <section className="bg-white py-24">
      <div className="max-w-[1280px] mx-auto px-8">
        {/* Section Header */}
        <div className="mb-12">
          <div className="font-space-mono text-xs text-[#38BDF8] uppercase tracking-[1.2px] mb-4">
            Deep Analysis
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
                ...
                {analysisData.marketScoring.map((item, index) => (
                  <div key={index}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="font-space-mono font-bold text-sm text-[#38BDF8]">
                        {item.score}%
                      </span>
                    </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {analysisData.investmentMetrics.map((metric, index) => (
                  <div key={index} className="text-center">
                    <div className="font-space-mono font-bold text-2xl text-[#38BDF8] mb-1">
                      {metric.value}
                    </div>
            ...
            <div className="bg-[#38BDF8] text-white rounded-xl p-6 flex items-center justify-between">
              <div>
