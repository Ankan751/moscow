  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row">
        ...
        >
          {(() => {
            const imageUrl = Array.isArray(listing.image) ? listing.image[0] : (typeof listing.image === 'string' ? listing.image : null);
            return imageUrl ? (
              <img
                src={imageUrl}
                alt={listing.title}
